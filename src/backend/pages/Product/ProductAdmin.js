...
function ProductAdmin() {
    ...
    useEffect(() => {
        apiProduct.getProductPagination(page, limit).then(res => {
          ...
          // console.log(data);
            ...
            try{
                const numberOfPages = res.data.last_page;
    ...
    const handleDeleteProduct = (id) => {
      apiProduct.deleteProductById(id,{
        headers: {
        ...
        try{          
          ...
          toast.warning(`Warning! Delete ${res.data.name} from Database`, {
            position: "top-right",
            autoClose: 2000,
            ...
            return (
              <tr key={key}>             
                ...
                <td>
                {
                  ...
                  item.image.map((i,key) => {
                    return (
                      <img          
                      key={key}
                      src={imageUrl + i}
                      alt="ProductImage" style={{width: "100px", height: "100px", objectFit: "cover"}} />
                    )
                  })
                }
                </td>
